...
shinyUI(fluidPage(
  ...
  tags$head(
    ...
    tags$script(src = "components/external/aframe-animation-component.js"),
    tags$script(src = "components/external/aframe-layout-component.js"),
    tags$script(src = "components/external/aframe-sun-sky.js"),
    tags$script(src = "components/external/aframe-bmfont-text-component.js"),
    tags$script(src = "components/external/aframe-physics-system.js"),
    tags$script(src = "components/external/aframe-extras.js"),
    # custom components
    tags$script(src = "components/custom/data-frame.js"),
    tags$script(src = "components/custom/data-frame-column.js"),
    tags$script(src = "components/custom/aframe-physics-sleepy.js"),
    tags$script(src = "components/custom/aframe-physics-collision-filter.js"),
    tags$script(src = "components/custom/aframe-stretch.js"),
    tags$script(src = "components/custom/aframe-plot.js"),
